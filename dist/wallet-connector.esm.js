...
var __DEV__ = process.env.BUILD_TYPE !== 'dev';

var walletProvider = window.dexEthereum;
...
var NoEthereumProviderError = /*#__PURE__*/function (_Error) {
  ...
  function NoEthereumProviderError() {
    ...
    _this.message = 'No Ethereum provider was found on window.dexEthereum.';
    return _this;
  }
...
var DexMaskConnector = /*#__PURE__*/function (_AbstractConnector) {
  _inheritsLoose(DexMaskConnector, _AbstractConnector);

  function DexMaskConnector(kwargs) {
    var _this3;
  ...
  var _proto = DexMaskConnector.prototype;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 2:
              if (walletProvider.on) {
                walletProvider.on('chainChanged', this.handleChainChanged);
                walletProvider.on('accountsChanged', this.handleAccountsChanged);
                walletProvider.on('close', this.handleClose);
                walletProvider.on('networkChanged', this.handleNetworkChanged);
              }
              ...
              _context.prev = 4;
              _context.next = 7;
              return walletProvider.send('eth_requestAccounts').then(function (sendReturn) {
            ...
            case 15:
              ...
              _context.next = 18;
              return walletProvider.enable().then(function (sendReturn) {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", walletProvider);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              _context3.prev = 2;
              _context3.next = 5;
              return walletProvider.send('eth_chainId').then(parseSendReturn);
            ...
            case 11:
              ...
              _context3.prev = 12;
              _context3.next = 15;
              return walletProvider.send('net_version').then(parseSendReturn);
            ...
            case 21:
              if (!chainId) {
                try {
                  chainId = parseSendReturn(walletProvider.send({
                    method: 'net_version'
                  }));
                } catch (_unused3) {
              ...
              if (!chainId) {
                if (walletProvider.isDapper) {
                  chainId = parseSendReturn(walletProvider.cachedResults.net_version);
                } else {
                  chainId = walletProvider.chainId || walletProvider.netVersion || walletProvider.networkVersion || walletProvider._chainId;
                }
              }
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              _context4.prev = 2;
              _context4.next = 5;
              return walletProvider.send('eth_accounts').then(function (sendReturn) {
                return parseSendReturn(sendReturn)[0];
              });
            ...
            case 21:
              if (!account) {
                account = parseSendReturn(walletProvider.send({
                  method: 'eth_accounts'
                }))[0];
              }
  ...
  return DexMaskConnector;
}(AbstractConnector);

export { DexMaskConnector, NoEthereumProviderError, UserRejectedRequestError };
//# sourceMappingURL=wallet-connector.esm.js.map
